#função consultar_pedido_python_ver1.1()
#foram corrigidos erros nessa versão
'''
...
#FUNÇÃO DE CONSULTAR O PEDIDO (SIMPLES)
def consultar_pedido(numero_digitado, lista_pedidos):
    '''
       ...
       retornará o pedido
    '''
    for pedido in lista_pedidos: #percorre a lista em busca do pedido
        if pedido["numero_pedido"] == numero_digitado: #numero_pedido é o numero que foi associado lá na criação
            return pedido #retorna os dados equivalente a este pedido
    return None #aqui caso não encontre ele precis retornar uma "resposta" negativa(no casco vazia)
...
def mostrar_pedido(pedido):
    ...
    print(f"Valor total: R$ {valor_formatado}")
    print("===============================================")
...
while continuar_consulta == "s":
    try:
        ...
        pedido_encontrado = consultar_pedido(numero_digitado,lista_pedidos)
        ...
        essa linha lê a resposta do usuário para continuar consultando ou não
        '''
