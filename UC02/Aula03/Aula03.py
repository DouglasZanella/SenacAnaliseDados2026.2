...
conexao = mysql.connector.connect(
    host="127.0.0.1", #precisa ser o IP da máquina local (verificar no Workbench)
    user="root", 
    password="", #por utilizar o XAMPP não é necessário ter a senha descrita
    database="meu_ecommerce" #banco criado em aulas para exemplo
)
