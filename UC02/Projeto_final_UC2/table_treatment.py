...
# 1 -CSV PRINCIPAL :
df_vgsales2024 = pd.read_csv('UC02\\Projeto_final_UC2\\Fonte_Dados_Original\\vgchartz-2024.csv')
...
# 2 -CSV SECUNDÁRIO :
df_secundary_vgsales = pd.read_csv('UC02\\Projeto_final_UC2\\Fonte_Dados_Original\\video_games_sales.csv')
...
# 3- CSV CONSOLES: 
df_consoles = pd.read_csv('UC02\\Projeto_final_UC2\\Fonte_Dados_Original\\videogameconsoles.csv')
...
df_secundary_vgsales_tratado = df_secundaryvgsales_renametitle
df_console_tratado = df_consoles_renamecolumn


# SALVA OS ARQUIVOS CSV TRATADOS NA PASTA DE FONTE_DADOS_TRATADOS:
df_vgsales2024_tratado.to_csv('UC02\\Projeto_final_UC2\\Fonte_Dados_tratados\\df_vgsales2024_tratado.csv', index=False, sep=',', encoding='utf-8')
df_secundary_vgsales_tratado.to_csv('UC02\\Projeto_final_UC2\\Fonte_Dados_tratados\\df_secundary_vgsales_tratado.csv', index=False, sep=',', encoding='utf-8')
df_console_tratado.to_csv('UC02\\Projeto_final_UC2\\Fonte_Dados_tratados\\df_console_tratado.csv', index=False, sep=',', encoding='utf-8')

print("\n Salvamento dos arquivos CSV consluído com sucesso!")
